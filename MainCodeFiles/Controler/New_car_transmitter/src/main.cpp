...
void loop() {
  ...
  bool e_stop_read=digitalRead(button_stop);
  bool manuel_read=digitalRead(button_manuel);

  my_data_package.stop=e_stop_read;
  my_data_package.manuel=manuel_read;
  ...
  my_data_package.y = y_value;
  my_data_package.x = x_value;
  ...
  Serial.println("e_stop_read: "+String(my_data_package.stop)+", manuel_read: "+String(my_data_package.manuel));
